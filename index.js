...
await itsmevall.updatePresence(from, Presence.composing)
    ...
    const ownerNumber = [`6283871990243@s.whatsapp.net`]
...
const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `© 𝑿𝒓𝒖𝒕𝒛 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍`,body:"",previewType:"PHOTO",thumbnail:bgg,sourceUrl:`https://wa.me/6283871990243?text=Hello bro`}}})
		}
...
case 'help':
case 'menu':
       txtt =`${ucapanWaktu} *${pushname}*\n*Butuh bantuan?* Silahkan pakai Fitur yang ada di *XrutzBot!*`
...
case 'ytgw':
  reply('https://youtube.com/c/XrutzBOT')
					break;
   case 'ss':
      reply(mess.wait)
